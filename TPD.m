...
p1 = plot(stim_finger,output_finger*10,'r.','MarkerSize',30); %点でプロット

hold on %前の図も残るように固定
p2 =plot(stim_palm,output_palm*10,'b.','MarkerSize',30);
hold off
...
hold on 
p3 = plot(stim_x,yfit_palm*10,'b-',stim_x,yfit_finger*10,'r-');
hold off
...
fprintf(fileId, '感度: %4.2f(Palm), %4.2f(Finger)',sensitivity_palm,sensitivity_finger);
